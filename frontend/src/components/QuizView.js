...
class QuizView extends Component {
  ...
  renderFinalScore() {
    const totalQuestions = this.state.previousQuestions.length; // Number of questions attended
    const numCorrect = this.state.numCorrect; // Number of correct answers
  
    return (
      <div className='quiz-play-holder'>
        <div className='final-header'>
          Your Final Score is {numCorrect}/{totalQuestions} (
